...
ok($event =~ /<img src="\/kalendar\/obrazek-[0-9]+-[0-9]+-.+-[0-9]+\.jpg" alt="Testovací popis" width="450" height="600" \/>/,'Obrázek');
...
ok($vymaz =~ /<img src="\/kalendar\/obrazek-[0-9]+-[0-9]+-.+-[0-9]+\.jpg" alt="Testovací popis" width="450" height="600" \/>/,'Obrázek - smazaná událost');

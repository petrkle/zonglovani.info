...
ok($event =~ /<img src="\/kalendar\/obrazek-[0-9]+-[0-9]+-.+-[0-9]+\.jpg" alt="Testovací popis" style="width:98%;max-width:450px;" \/>/,'Obrázek');
...
ok($vymaz =~ /<img src="\/kalendar\/obrazek-[0-9]+-[0-9]+-.+-[0-9]+\.jpg" alt="Testovací popis" style="width:98%;max-width:450px;" \/>/,'Obrázek - smazaná událost');

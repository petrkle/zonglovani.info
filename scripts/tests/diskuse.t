...
my @vzkazy = (
	{'z'=>'[url=http://nekde.cz]testovací odkaz[/url]', 'v'=>'<a href="http:\/\/nekde.cz" class="external" rel="nofollow" onclick="pageTracker\._trackPageview\(\'\/goto\/nekde\.cz\'\);">testovací odkaz<\/a>', 't'=>'Externí odkaz'},

...
<li><a href="http://pear.php.net/package/Pager" onclick="pageTracker._trackPageview('/goto/pear.php.net/package/Pager');" class="external">Pager</a> - stránkování</li>
...
<li><a href="http://www.gnu.org/software/wget" onclick="pageTracker._trackPageview('/goto/gnu.org/software/wget');" class="external">wget</a> - automatizace</li>

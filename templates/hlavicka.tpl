...
<div id="hlavicka">
<div id="ucet"><a href="{$smarty.const.LIDE_URL}prihlaseni.php" title="Přihlášení do žonglérova slabikáře">Přihlášení</a> | <a href="{$smarty.const.LIDE_URL}pravidla.php" title="Vytvořit nový účet v žonglérově slabikáři.">Nový účet</a></div>

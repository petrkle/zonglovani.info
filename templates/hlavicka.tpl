...
<div id="hlavicka">
<div id="ucet">
{if $smarty.session.logged==true}<a href="{$smarty.const.LIDE_URL}{$smarty.session.uzivatel.login|escape}.html" title="Tvůj profil.">{$smarty.session.uzivatel.login|escape}</a> | <a href="">Nastavení</a> | <a href="{$smarty.const.LIDE_URL}odhlaseni.php{if $smarty.server.REQUEST_URI!="/"}?next={$smarty.server.REQUEST_URI}{/if}" title="Odhlásit se">Odhlásit</a>{else}

...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://purl.org/rss/1.0/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:sy="http://purl.org/rss/1.0/modules/syndication/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:taxo="http://purl.org/rss/1.0/modules/taxonomy/">
  <channel rdf:about="https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}">
    <title>Obrázky žonglování</title>
    <link>https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}</link>
    ...
    <items>
      <rdf:Seq>
        ...
        <rdf:li resource="https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}{$obrazky[$smarty.section.smycka1.index].name}/" />
				{/if}
				{/section}
      </rdf:Seq>
    </items>
...
{section loop=$obrazky name=smycka2 step=-1}
  ...
  <item rdf:about="https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}{$obrazky[$smarty.section.smycka2.index].name}/">
    <title>{$obrazky[$smarty.section.smycka2.index].title|escape}</title>
    <link>https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}{$obrazky[$smarty.section.smycka2.index].name}/</link>

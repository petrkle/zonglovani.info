...
<a name="gmiball"></a><h3><a href="/gmiball.pdf" title="Návod na ušití míčku" onclick="pageTracker._trackPageview('/gmiball.pdf');" class="pdf">Gamiballs</a></h3>

<p>
<a href="/gmiball.pdf" onclick="pageTracker._trackPageview('/gmiball.pdf');" title="Gamiballs">{obrazek soubor="gmiball.jpg" popisek="Gamiballs"}</a>
Obrázkový návod od <a href="http://www.barf.cc/diagrams/PDF_diagrams/pdf_diagrams.html" class="external" onclick="pageTracker._trackPageview('/goto/barf.cc/diagrams/PDF_diagrams/pdf_diagrams.html');">Jeremyho Shafera</a> jak ušít míček z jednoho kusu látky. Popis je anglicky.
</p>

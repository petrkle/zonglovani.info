...
<ul>
<li><label class="kratkypopis" for="nazev" accesskey="n" ><span class="u">N</span>ázev</label><input type="text" name="title" id="nazev" value="{$udalost.title|escape}" class="textbox" tabindex="1"/><div class="tooltip">Název akce. Délka od 3 do 100 znaků.</div></li>
<li><label class="kratkypopis" for="popis" accesskey="p" ><span class="u">P</span>opis</label><input type="text" name="desc" id="popis" value="{$udalost.desc|escape}" class="textbox" tabindex="2"/><div class="tooltip">Podrobný popis akce. Délka 3 až 3000 znaků.</div></li>
</ul>
</fieldset>
...
<ul>
<li><label class="kratkypopis" for="misto" accesskey="m" ><span class="u">M</span>ísto</label><input type="text" name="misto" id="misto" value="{$udalost.misto|escape}" class="textbox" tabindex="3"/><div class="tooltip">Místo konání události. Délka od 2 do 200 zanků.</div></li>
...
<li><label class="kratkypopis" for="konec" accesskey="k" ><span class="u">K</span>onec</label> {literal}<script type="text/javascript">new tcal ({'formname': 'cal','controlname': 'konec'});</script>{/literal}<input type="text" name="konec" id="konec" value="{$udalost.konec|escape}" class="datebox" tabindex="5"/><div class="tooltip">Datum a čas ukončení události. Formát datumu "RRRR-MM-DD&nbsp;HH:MM"</div></li>
</ul>
</fieldset>

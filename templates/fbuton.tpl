...
tento článek na Facebooku" style="font-weight:bold;padding:10px 25px;cursor:pointer;" onclick="_gaq.push(['_trackPageview','/goto/facebook.com/share{$smarty.server.REQUEST_URI}']);"/></p></form>
{/if}

...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://purl.org/rss/1.0/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:sy="http://purl.org/rss/1.0/modules/syndication/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:taxo="http://purl.org/rss/1.0/modules/taxonomy/">
  <channel rdf:about="https://{$smarty.server.SERVER_NAME}{$smarty.const.CALENDAR_URL}">
    ...
    <items>
      <rdf:Seq>
        ...
        <rdf:li resource="https://{$smarty.server.SERVER_NAME}{$smarty.const.CALENDAR_URL}udalost-{$udalost.id}.html" />
				{/if}
				{/foreach}
      </rdf:Seq>
    </items>
...
{foreach from=$events item=udalost name=smycka2}
  ...
  <item rdf:about="https://{$smarty.server.SERVER_NAME}{$smarty.const.CALENDAR_URL}udalost-{$udalost.id}.html">
    <title>{$udalost.title}</title>
    <link>https://{$smarty.server.SERVER_NAME}{$smarty.const.CALENDAR_URL}udalost-{$udalost.id}.html</link>

...
<h3>Rozcvička</h3>
<p>
{obrazek soubor="trenink-navoda.png" popisek="Rozcvička"}
Prvním bodem tréninku je rozcvička. Zvolna rozhýbej svoje ruce, ramena, krk, hlavu ... Protáhni si šlachy a přidej i pár náročnějších cviků aby se ti rozproudila krev. Nástrojem žongléra je jeho tělo a je třeba ho připravit. Rozcvička by mohla trvat asi pět minut, ale není třeba měřit to na stopkách.
</p>
<h3>Začínáme</h3>
<p>
{obrazek soubor="trenink-navodb.png" popisek="První hod"}
Teď už se můžeš pustit do vlastního žonglování. Je dobré začít <a href="/micky/3/kaskada.html" title="Základní trik se třemi míčky.">lehčími triky</a> a postupně přejít až k těm které se zrovna učíš. Trénink nesmí být nudný nebo stereotypní. Tudy cesta nevede, protože tě to pak nebude bavit. Naopak žonglování je zábava a mělo by přinášet potěšení. Takže střídej různé triky (kaskáda, sprcha, sloupy, ...) a trénuj plynulý přechod z jednoho triku do druhého. Zkus při žonglování stát na jedné noze nebo chodit. Inspirovat tě může i <a href="/horoskop/" title="Horoskop pro žongléry.">horoskop pro žongléry</a>.
</p>
<h3>Hudba</h3>
<p>
...
Snaž se trénovat v různou dobu a na různých místech. Získáš tak jistotu v odlišných podmínkách a nevyvede tě z míry třeba protisvětlo, jiné rozestavění nábytku nebo okolní ruch. Občas vezmi do ruky místo svých oblíbených míčků třeba <a href="/micky/3/jablko.html" title="Žonglování s jablky.">jablka</a> nebo pomeranče. Až se vrátíš zpátky k míčkům tak zjistíš, že je to s nimi daleko snazší.
</p>

<h3>Pravá i levá ruka</h3>
<p>
{obrazek soubor="trenink-navodg.png" popisek="Ruce"}
Když se chceš naučit nový trik začni svojí šikovnější rukou. Když jsi pravák a chceš zvládnout <a href="/micky/2/2v1.html" title="Trik se dvěma míčky.">2 v 1</a> začneš nejdřív v pravé ruce. A až poté co se to naučíš zkusíš to i v levé. Půjde ti to líp než začínat rovnou pravou i levou. Je důležité trénovat obě ruce tak aby zvládaly stejné věci, většinou to znamená trénovat víc s nešikovnou rukou.
</p>

<h3>Krize</h3>
<p>
{obrazek soubor="trenink-navodh.png" popisek="Něco jiného"}

...
{if isset($navigace.dalsi)}
	<li class="link_next">Další místo: <a href="{$navigace.dalsi.url|escape}" title="{$navigace.dalsi.title|escape}" id="dalsi">{$navigace.dalsi.text|escape}</a></li>
{/if}
{if isset($navigace.predchozi)}
	<li class="link_prev">Předchozí místo: <a href="{$navigace.predchozi.url|escape}" title="{$navigace.predchozi.title|escape}" id="predchozi">{$navigace.predchozi.text|escape}</a></li>
{/if}
</ul>
</div>

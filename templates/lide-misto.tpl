<p>
<a href="{$smarty.const.LIDE_URL}misto/" title="Další možnosti filtrování.">Výběr</a> ze <a href="{$smarty.const.LIDE_URL}" title="Všichni uživatelé žonglérova slabikáře.">seznamu žonglérů</a>.
</p>
<p>

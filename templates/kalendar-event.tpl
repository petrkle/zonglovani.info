...
{if $udalost.mapa}
<p>
<a href="{$udalost.mapa|escape}" onclick="pageTracker._trackPageview('/goto/{$udalost.mapa|replace:'http://':''|regex_replace:"/^www\./":""}');" title="Místo konání na mapì."{if eregi("^http://",$udalost.mapa)} class="external" rel="nofollow"{/if}>Mapa</a>
</p>
{/if}
<p>

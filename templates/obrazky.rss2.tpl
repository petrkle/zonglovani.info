...
<atom:link href="https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}obrazky.xml" rel="self" type="application/rss+xml" />
...
<image>
<url>https://{$smarty.server.SERVER_NAME}/img/s/slabikar-fb.png</url>
<title>Obrázky žonglování</title>
<link>https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}</link>
</image>
...
{section loop=$obrazky name=smycka2 step=-1}
  ...
  <item>
    ...
    <pubDate>{$obrazky[$smarty.section.smycka2.index].datum_rss2|escape}</pubDate>
		<guid>https://{$smarty.server.SERVER_NAME}{$smarty.const.OBRAZKY_URL}{$obrazky[$smarty.section.smycka2.index].name}/</guid>
  </item>
	{/if}
{/section}

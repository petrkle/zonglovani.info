...
<p>
<a href="1024x768/{$obrazek.soubor}" title="{$obrazek.basename} rozlišení 1024x768" onclick="_gaq.push(['_trackPageview','{$smarty.const.WALLPAPERS_URL}1024x768/{$obrazek.soubor}']);"><img src="{$obrazek.nahled_url}" width="{$obrazek.nahled_sirka}" height="{$obrazek.nahled_vyska}" alt="{$obrazek.basename}"/></a>
</p>
<ul class="szn">

...
<ul>
<li><label for="heslo" accesskey="n" class="kratkypopis"><span class="u">N</span>ový&nbsp;email:</label><input type="text" name="email" id="email" value="" class="textbox" tabindex="1"/><div class="tooltip">Nová adresa elektronické pošty</div></li>

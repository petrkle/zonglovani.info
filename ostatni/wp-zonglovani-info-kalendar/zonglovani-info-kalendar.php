...
<ul>
<li><label><input type="radio" value="vertical" name="<?php echo $this->get_field_name('layout'); ?>" <?php if ($layout == 'vertical') {
            echo 'checked="checked"';
        } ?>> Na výšku</label></li>
<li><label><input type="radio" value="horizontal" name="<?php echo $this->get_field_name('layout'); ?>"<?php if ($layout == 'horizontal') {
            echo 'checked="checked"';
        } ?>> Vodorovně</label></li>
</ul>
</fieldset>
...
<legend>Styl</legend>
<ul>
<li><label><input type="radio" value="light" name="<?php echo $this->get_field_name('color'); ?>" <?php if ($color == 'light') {
            echo 'checked="checked"';
        } ?>> Světlý</label></li>
<li><label><input type="radio" value="dark" name="<?php echo $this->get_field_name('color'); ?>" <?php if ($color == 'dark') {
            echo 'checked="checked"';
        } ?>> Tmavý</label></li>
</ul>
</fieldset>

...
function smarty_function_jsvideo($params, &$smarty){
	...
	if(is_readable($_SERVER['DOCUMENT_ROOT'].'/video/klip/navod/'.$v.'.xml')){
			...
			if(isset($klip['youtube'])){
				$include = "<iframe id=\\'player\\' type=\\'text/html\\' class=\\'wyoutubevideo\\' src=\\'https://www.youtube.com/embed/".$klip['youtube']."?enablejsapi=1&origin=https://".$_SERVER['SERVER_NAME']."&autoplay=1&autohide=1&border=0&loop=1&playlist=".$klip['youtube']."\\' frameborder=\\'0\\'></iframe>";
			}else{

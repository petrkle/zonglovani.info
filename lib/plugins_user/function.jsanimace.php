...
function smarty_function_jsanimace($params, &$smarty){
	...
	if(is_readable($_SERVER['DOCUMENT_ROOT'].'/animace/'.$prefix.'/'.$a.'.gif')){
		...
		$vysledek="this.parentNode.innerHTML='<img src=\\'/animace/$prefix/$a.gif\\' width=\\'".$rozmery[0]."\\' height=\\'".$rozmery[1]."\\' style=\\'border:solid 1px #000;\\'/>';_gaq.push(['_trackPageview','/animace/$a.html']);return false;";
	}else{

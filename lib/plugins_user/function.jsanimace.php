...
function smarty_function_jsanimace($params, &$smarty){
	...
	if(is_readable($_SERVER['DOCUMENT_ROOT'].'/animace/img/'.$a.'.gif')){
		...
		$vysledek="this.parentNode.innerHTML='<img src=\\'/animace/img/$a.gif\\' width=\\'".$rozmery[0]."\\' height=\\'".$rozmery[1]."\\' style=\\'border:solid 1px #000;\\'/>';_gaq.push(['_trackPageview','/animace/$a.html']);return false;";
	}else{

...
/*********************************************************************************/
   ...
   */
  public function deleteProperty($propName, $propix = false)
  {
...
/*********************************************************************************/
  ...
  {
      $this->dtstamp['value'] = array('year' => date('Y'), 'month' => date('m'), 'day' => date('d'), 'hour' => date('H'), 'min' => date('i'), 'sec' => date('s') - date('Z'));
...
/*********************************************************************************/
  ...
  public function createOrganizer()
  {
      ...
      $attributes = $this->_createParams($this->organizer['params'], array('CN', 'DIR', 'LANGUAGE', 'SENT-BY'));
...
/*********************************************************************************/
  ...
  public function setTrigger($year, $month = null, $day = null, $week = false, $hour = false, $min = false, $sec = false, $relatedStart = true, $before = true, $params = false)
  {
      ...
      $this->trigger = array('params' => $params);
          ...
          $this->trigger['value'] = array('relatedStart' => $relatedStart, 'before' => $before);
          if (!empty($week)) {
...
/*********************************************************************************/
   ...
   */
  public function _chkdatecfg($theDate, &$parno, &$params)
  {
   ...
   */
  public function _date2duration($startdate = false, $enddate = false)
  {
   ...
   * @return timestamp
   */
  public function _date2timestamp($datetime, $tz = null)
  {
      $output = null;
   ...
   * @return array
   */
  public function _date_time_array($datetime, $parno = false)
  {
      $output = array();
   ...
   * @return array
   */
  public function _date_time_string($datetime, $parno = false)
  {
   ...
   * @return array
   */
  public function _duration_array($duration)
  {
      $output = array();
   ...
   */
  public function duration2date($startdate = false, $duration = false)
  {
   ...
   * @return array
   */
  public function _duration_string($duration)
  {
   ...
   * @return int
   */
  public function _existRem(&$array, $expkey, $expval = false, $hitVal = null, $elseVal = null, $preSet = null)
  {
      if ($preSet) {
          return $preSet;
      }
   ...
   * @return string
   */
  public function _format_date_time($datetime, $parno = 6)
  {
   ...
   * @return string
   */
  public function _format_duration($duration)
  {
   ...
   * @return string
   */
  public function _formatPropertyName($propertyName)
  {
      switch ($this->format) {
      case 'xcal':
   ...
   * @return bool
   */
  public function _isArrayDate($input)
  {
   ...
   * @return bool
   */
  public function _isArrayTimestampDate($input)
  {
   ...
   * @return bool
   */
  public function _isOffset($input)
  {
   ...
   */
  public function _recur2date(&$result, $recur, $wdate, $startdate, $enddate = false)
  {
...
// echo "recur __in_ ".implode('-',$startdate)." period start ".implode('-',$wdate)." period end ".implode('-',$enddate)."<br />\n";print_r($recur);echo "<br />\n";//test###
   ...
   //echo "cont: ".implode('-',$wdate)." ix=$intervalix old=$currentKey interval=".$intervalarr[$intervalix]."<br />\n";//test
        ...
        if ($updateOK && isset($recur['BYMONTH'])) {
            $updateOK = $this->_recurBYcntcheck($recur['BYMONTH'], $wdate['month'], ($wdate['month'] - 13));
        }
        if ($updateOK && isset($recur['BYWEEKNO'])) {
            $updateOK = $this->_recurBYcntcheck($recur['BYWEEKNO'], $daycnts[$wdate['month']][$wdate['day']]['weekno_up'], $daycnts[$wdate['month']][$wdate['day']]['weekno_down']);
        }
        if ($updateOK && isset($recur['BYYEARDAY'])) {
            $updateOK = $this->_recurBYcntcheck($recur['BYYEARDAY'], $daycnts[$wdate['month']][$wdate['day']]['yearcnt_up'], $daycnts[$wdate['month']][$wdate['day']]['yearcnt_down']);
        }
        if ($updateOK && isset($recur['BYMONTHDAY'])) {
            $updateOK = $this->_recurBYcntcheck($recur['BYMONTHDAY'], $wdate['day'], $daycnts[$wdate['month']][$wdate['day']]['monthcnt_down']);
        }
          ...
          $daynoexists = $daynosw = $daynamesw = false;
              ...
              if (isset($recur['BYDAY'][0])) {
                  ...
                  if ((isset($recur['FREQ']) && ($recur['FREQ'] == 'MONTHLY')) || isset($recur['BYMONTH'])) {
                      $daynosw = $this->_recurBYcntcheck($recur['BYDAY'][0], $daycnts[$m][$d]['monthdayno_up'], $daycnts[$m][$d]['monthdayno_down']);
                  } elseif (isset($recur['FREQ']) && ($recur['FREQ'] == 'YEARLY')) {
                      $daynosw = $this->_recurBYcntcheck($recur['BYDAY'][0], $daycnts[$m][$d]['yeardayno_up'], $daycnts[$m][$d]['yeardayno_down']);
                  }
              }
        ...
        //echo "daynoexists:$daynoexists daynosw:$daynosw daynamesw:$daynamesw<br />\n"; // test ###
              ...
              foreach ($recur['BYDAY'] as $bydayvalue) {
                  ...
                  if (isset($bydayvalue[0])) {
                   ...
                   isset($recur['BYMONTH'])) {
                          $daynosw = $this->_recurBYcntcheck($bydayvalue['0'], $daycnts[$m][$d]['monthdayno_up'], $daycnts[$m][$d]['monthdayno_down']);
                      } elseif (isset($recur['FREQ']) && ($recur['FREQ'] == 'YEARLY')) {
                          $daynosw = $this->_recurBYcntcheck($bydayvalue['0'], $daycnts[$m][$d]['yeardayno_up'], $daycnts[$m][$d]['yeardayno_down']);
                      }
                  }
        //echo "daynoexists:$daynoexists daynosw:$daynosw daynamesw:$daynamesw<br />\n"; // test ###
            if (($daynoexists && $daynosw && $daynamesw) ||
    ...
    public function _recurBYcntcheck($BYvalue, $upValue, $downValue)
    {
        if (is_array($BYvalue) &&
    ...
    public function _recurIntervalIx($freq, $date, $wkst)
    {
        /* create interval index */
    switch ($freq) {
      case 'YEARLY':
   ...
   * @return array
   */
  public function _setRexrule($rexrule)
  {
      $input = array();
      if (empty($rexrule)) {
          return $input;
   ...
   * @return array
   */
  public function _setDate($year, $month = false, $day = false, $hour = false, $min = false, $sec = false, $tz = false, $params = false, $caller = null)
  {
      $input = $parno = null;
   ...
   * @return array
   */
  public function _setDate2($year, $month = false, $day = false, $hour = false, $min = false, $sec = false, $params = false)
  {
      $input = null;
      if ($this->_isArrayDate($year)) {
   ...
   * @param int $index
   */
  public function _setMval(&$valArr, $value, $params = false, $defaults = false, $index = false)
  {
      if (!is_array($valArr)) {
          $valArr = array();
      }
   ...
   * @return array
   */
  public function _setParams($params, $defaults = false)
  {
      if (!is_array($params)) {
          $params = array();
      }
   ...
   */
  public function _stepdate(&$date, &$timestamp, $step = array('day' => 1))
  {
   ...
   * @return array
   */
  public function _timestamp2date($timestamp, $parno = 6)
  {
      ...
      $output = array('year' => date('Y', $timestamp), 'month' => date('m', $timestamp), 'day' => date('d', $timestamp));
      if (3 != $parno) {
...
/*********************************************************************************/
   ...
   * @return bool TRUE
   */
  public function deletePropertyM(&$multiprop, $propix = 0)
  {
...
/********************************************************************************/
   ...
   * @return string
   */
  public function _size75($string)
  {
   ...
   * @return string
   */
  public function _strrep($string)
  {
      switch ($this->format) {
      case 'xcal':
        $string = str_replace('\n',  $this->nl, $string);
...
//        if( FALSE !== strpos( $string, $this->nl ))
   ...
   * @return string
   */
  public function _strunrep($string)
  {
      $string = str_replace('\\\\', '\\',     $string);
      $string = str_replace('\,',   ',',      $string);
      $string = str_replace('\;',   ';',      $string);
...
class vtimezone extends calendarComponent
{
   ...
   */
  public function vtimezone($timezonetype = false)
  {
      if (!$timezonetype) {

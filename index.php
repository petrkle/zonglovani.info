...
<a href="/micky/" title="®onglování s míèky."><? echo img("micky.png","Míèky"); ?></a>
</div>


<div style="float: left; margin: 15px 15px 0 15px; text-align: center;">
<a href="/kruhy/" title="®onglování s kruhy."><? echo img("kruhy.png","Kruhy"); ?></a>
</div>


<div style="float: left; margin: 15px 0px 0 15px; text-align: center;">
<a href="/kuzely/" title="®onglování s ku¾ely."><? echo img("kuzely.png","Ku¾ely"); ?></a>
</div>

<p>
®onglérùv slabikáø je uèebnice ¾onglování se spoustou barevných obrázkù. Nejvìt¹í èást je vìnovaná míèkùm. Dozví¹ se také nìco málo o kruzích, ku¾elech a <a href="/chudy/" title="Chùdy">chùdách</a>.
</p>
...
<p>
<ul>
<li><a href="/nacini.html" title="Popis rùzných ¾onglovátek.">®onglérské náèiní</a> - s èím v¹ím se dá ¾onglovat.</li>

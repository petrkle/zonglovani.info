...
@conf::excludefiles = ('/mapa-stranek.html','/kalendar/*.html','/diskuse/*.html','/lide/*.html','/forum/*.html','/lide/prihlaseni.php\?next=.*','/obrazky/*.html','/obrazky/*/stranka*/','/toolbox.html');

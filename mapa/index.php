...
if(isset($_GET['country'])){
	if($_GET['country']=='cr'){
		...
		$titulek.=' - ČR';
		$smarty->assign('nahled','https://'.$_SERVER['SERVER_NAME'].'/mapa/static/m/mapa-cr.png');
	}else{
		$country='sk';
		...
		$titulek.=' - SR';
		$smarty->assign('nahled','https://'.$_SERVER['SERVER_NAME'].'/mapa/static/m/mapa-sk.png');
	}
}else{
	$country='false';
}
...
if(!$poloha){
	...
	$smarty->assign('nahled','https://'.$_SERVER['SERVER_NAME'].'/mapa/static/m/mapa-crsk.png');
